  ...
  return (
    <div>
      <Layout>
          ...
          <div className="flex-row">
            <div className="menu-column-left">
              ...
              <p>
                ...
                piri piri 2<br />
                hash browns, kale, mushrooms, avocado, halloumi, ricotta, labne,
                olives 3.5
                <br />
                bacon, chorizo 4<br />
              ...
              <p>
                <strong>sourdough buttermilk pancakes &amp; maple 17</strong>
                <br />
            ...
            <div className="menu-column-right">
              <p>
                ...
                <br />w rhubarb compote, apple, hazelnut, brown sugar or honey
              </p>
              <p>
              ...
              <p>
                ...
                <br />w figs, strawberries, grapes, pepitas, coconut, almonds
                &amp; sesame seeds
              </p>
              <h4>
        ...
        <div className="flex-row">
          <div className="menu-column-left">
            ...
            <p>
              ...
              <br />
              crispy bacon, avo, tomato, cos, chilli aioli on toasted focaccia
              <br />
              add fried egg 17
            </p>
            <p>
              ...
              <br />
              english muffin w bacon, tomatoes, poached eggs, cheese &amp; hash
              browns
            </p>
            <p>
              <strong>veggie black stone 18</strong>
              <br />> english muffin w mushrooms, tomatoes, poached eggs, cheese
              &amp; hash browns
            </p>
            <p>
          ...
          <div className="menu-column-right">
            <p>
              ...
              <br />
              jap pumpkin, mushroom, asian grene, furikake rice, poached eggs,
              miso dressing, toast
            </p>
            <p>
              <strong>breakfast platter 22/40</strong>
              <br />
              seasonal vegetables, avocado, quinoa, almond &amp; cauliflower
              tabouli, hash, eggs (poached or scrambled), fermented cabbage,
              labne &amp; olives, tahini, zhoug &amp; za’atar toast (vegan
              available)
            </p>
            <p>
              <strong>moroccan eggs 18</strong>
              <br />
              slow cooked spiced capsicum &amp; tomatoes w poached egg, tahini,
              zhoug &amp; za’atar toast
              <br />
              w goats cheese 21
              <br />
        ...
        {/* lunhc menu */}
        <div id="lunch_menu" className="flex-col visible">
          <div className="flex-col menu-heading">
            <h2>Lunch</h2>
            <sub>From 12pm</sub>
          </div>
          <div className="flex-row">
            <div className="menu-column-left">
              ...
              <p>
                ...
                <br />
                beetroot, farro, fresh pear, witlof, spinach, spiced walnuts,
                merlot dressing
              </p>
              <p>
            ...
            <div className="menu-column-right">
              ...
              <p>
                ...
                <br />
                chilli mayo, cos lettuce, crispy potatoes &amp; homemade pickles
                <br />
              ...
              <p>
                ...
                <br />
                avocado, aioli, homemade tomato relish, rocket &amp; homemade
                pickles
              </p>
              <p>
                <strong>grilled steak sandwich 19</strong>
                <br />
                beetroot, spanish onion, aioli, kasundi, rocket &amp; homemade
                pickles
              </p>
              <p>&nbsp;</p>
              <p>
        ...
        {/* dinner menu */}
        <div id="dinner_menu" className="flex-col visible">
          <div className="flex-col menu-heading">
            <h2>Dinner</h2>
            <sub>from 6pm</sub>
            <p>
          ...
          <div className="flex-row">
            <div className="menu-column-left">
              <h4>ENTREE</h4>
              <p>
                <strong>roasted cauliflower</strong>, shawarma spices, almonds,
                currants, sage brown butter 18
              </p>
              <p>
              ...
              <p>
                <strong>roasted figs</strong>, stracciatella, pistachio, bulgur,
                balsamic 20
              </p>
              <p>
              ...
              <p>
                <strong>Spanish mackerel tataki</strong>, corn, cherry tomato,
                nori crisp, anchoïade 21
              </p>
              <p>
                <strong>crispy pork belly</strong>, boudin noir, parsnip, apple,
                celery, jus 21
              </p>
              <p>
                <strong>hand cut steak tartare</strong>, wild mushrooms, yolk,
                potato gaufrette 21
              </p>
            </div>
            ...
            <div className="menu-column-right">
              ...
              <p>
                beetroot, radicchio, pear &amp; walnuts, merlot vinaigrette 12
              </p>
              <p>shaved cabbage, red apple, hazelnut, chives 12</p>
              <p>
                roasted carrots, baby onions, pistachio, sunflower sprouts 12
              </p>
            </div>
          </div>
          <div className="flex-row">
            <div className="menu-column-left">
              ...
              <br />
              <p>
                <strong>gold band snapper</strong>, eggplant, roasted capsicum,
                okra, basil caper salsa 35
              </p>
              <p>
                <strong>charred eggplant</strong>, crispy furikake rice, green
                tea dashi, shimeji 28
              </p>
              <p>
              ...
              <p>
                <strong>lamb rump</strong>, pistachio salsa verde, chargrilled
                onion, pumpkin, jus 37
              </p>
              <p>
              ...
              <p>
                ...
                <br /> choice of: porcini butter, bordelaise sauce, lemon olive
                oil
              </p>
            </div>
            ...
            <div className="menu-column-right">
              ...
              <p>
                hazelnut chocolate fondant, salted butterscotch &amp; vanilla
                ice cream 16
              </p>
              <p>
                kaffir lime meringue, pineapple ginger sorbet, passion fruit,
                Thai basil 15
              </p>
